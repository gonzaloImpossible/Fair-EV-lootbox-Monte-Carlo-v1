...
STRUCTURAL_ASSUMPTIONS = [
    ...
    # ---- Pull mechanic ----
    ("Pull stage 1 — tier",
     "Categorical sampling over {high, mid, low} with probs from config."),
    ("Pull stage 2 — NFT",
     "Uniform sampling over remaining inventory in the chosen tier. "
     "All NFTs in a tier are interchangeable to the user."),
    ("Tier-empty policy",
